  ...
  <div class="header_middle_section">
    ...
    <div class="search-bar">
      <form action="" method="get" id="search-form">
        <div class="input-div">
          <input id="search" type="text" name="search" class="search_area" placeholder="Search..." autocomplete="off"/>
        </div>
...
<script>
  $(document).ready(function() {
    // const liveSearchResult = $('.live-result')

    $('#search-form input').keyup(function() {
      // liveSearch($(this).val())
      $.ajax({
        type: 'POST',
        url: "/../OOP/php/search_provider.php",
        data: {
    ...
    $('#notif-count').on("click", function() {
      $.ajax({
        url: "/../OOP/php/readNotif.php",
...
<script src="/../OOP/js/get_notif.js"></script>
<script src="/../OOP/js/get_notifCount.js"></script>